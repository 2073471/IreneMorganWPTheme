 ...
 */
 function irenemorgan_theme_scripts() {
     wp_enqueue_style( 'irenemorgan', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'irenemorgan_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'irenemorgan' ),
            'footer-menu' => __( 'Footer Menu', 'irenemorgan' ),
            'social-menu' => __( 'Social Menu', 'irenemorgan'),
    ...
    function irenemorgan_theme_init(){
        ...
        add_action('after_setup_theme', 'irenemorgan_theme_init');
